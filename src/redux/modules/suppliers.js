...
const REMOVE = 'lance-web/suppliers/REMOVE';
const REMOVE_SUCCESS = 'lance-web/suppliers/REMOVE_SUCCESS';
const REMOVE_FAIL = 'lance-web/suppliers/REMOVE_FAIL';
...
export default function reducer(state = initialState, action = {}) {
  switch (action.type) {
    ...
    case SAVE_SUCCESS:
      return {
        ...state,
        data: [...state.data, action.result.supplier],
        loading: false,
        error: null
      };
    case SAVE_FAIL:
...
export function remove(id) {
  return {
    ...
    id: id,
    promise: (client) => client.post('/supplier/remove', {data: {id: id}})
  };
}
